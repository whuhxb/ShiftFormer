...
"""
Based on model13_full_conv_transformer, change DWConv3x3 to Shift in Token Mixer.
...
@register_model
def fct_s12_64_7118_TTT_SDWshift(pretrained=False, **kwargs):
    layers = [2, 2, 6, 2]
...
if __name__ == '__main__':
    ...
    model = fct_s12_64_7118_TTT_SDWshift()
    out = model(input)
    print(model)
    print(out.shape)
