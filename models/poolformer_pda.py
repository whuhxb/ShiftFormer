...
class PDConv2d(nn.Module):
    def __init__(self, in_chans, out_chans, kernel_size,  stride, padding):
        super().__init__()
        self.conv1 = nn.Conv2d(in_chans, out_chans, kernel_size=kernel_size, stride=stride, padding=padding)
        self.conv2 = nn.Conv2d(in_chans, out_chans, kernel_size=kernel_size, stride=stride, padding=padding)
        self.conv3 = nn.Conv2d(in_chans, out_chans, kernel_size=kernel_size, stride=stride, padding=padding)
        self.conv4 = nn.Conv2d(in_chans, out_chans, kernel_size=kernel_size, stride=stride, padding=padding)
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, patch_size=16, stride=16, padding=0, 
        ...
        self.proj = PDConv2d(in_chans, embed_dim, kernel_size=patch_size, stride=stride, padding=padding)
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, 
        ...
        self.fc1 = PDConv2d(in_features, hidden_features, kernel_size=1, stride=1, padding=0)
        self.act = act_layer()
        self.fc2 = PDConv2d(hidden_features, out_features, kernel_size=1, stride=1, padding=0)
...
@register_model
def poolformer_pda_s12(pretrained=False, **kwargs):
    """
