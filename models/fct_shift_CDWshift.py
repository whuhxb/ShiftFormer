...
"""
Based on model13_full_conv_transformer, change DWConv to Shift in FFN.
...
@register_model
def fct_s12_64_7118_TTT_CDWshift(pretrained=False, **kwargs):
    layers = [2, 2, 6, 2]
...
if __name__ == '__main__':
    ...
    model = fct_s12_64_7118_TTT_CDWshift()
    out = model(input)
    print(model)
    print(out.shape)
