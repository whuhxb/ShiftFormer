...
class Shifting(nn.Module):
    ...
    def forward(self, x):
        ...
        out[:, g * 0:g * 2, :, 0:W:2] = x[:, g * 0:g * 2, :, 1:W:2]  # shift W
        out[:, g * 0:g * 2, :, 1:W:2] = x[:, g * 0:g * 2, :, 0:W:2]  # shift W

        out[:, g * 2:g * 4, 0:H:2, :] = x[:, g * 2:g * 4, 1:W:2, :]  # shift H
        out[:, g * 2:g * 4, 1:H:2, :] = x[:, g * 2:g * 4, 0:W:2, :]  # shift H
...
@register_model
def model11_s12(pretrained=False, **kwargs):
    """
